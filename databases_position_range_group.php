  ...
  <html lang="en">
	...
	<body>
		...
		<div>
			...
			<form name="myform" >
				<input type="checkbox" onclick="var SNV_bool=true;"/><font size="4">SNVs</font>
				<input type="checkbox" onclick="var del_bool=true;"/><font size="4">deletions</font>
				<input type="checkbox" onclick="var ins_bool=true;"/><font size="4">insertions</font>
